...
Reference full template: `E:/project/symforge/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/project/symforge/.claude/get-shit-done/templates/state.md`.
