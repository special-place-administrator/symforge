...
<execution_context>
@E:/project/symforge/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @E:/project/symforge/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
